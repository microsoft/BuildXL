...
namespace BuildXL.Cache.ContentStore.Service
{
    ...
    public class LocalContentServer : LocalContentServerBase<IContentStore, IContentSession>
    {
        ...
        {
            _grpcContentServer = new GrpcContentServer(logger, Capabilities.ContentOnly, this, StoresByName, localContentServerConfiguration.BufferSizeForGrpcCopies, localContentServerConfiguration.GzipBarrierSizeForGrpcCopies);
        }
