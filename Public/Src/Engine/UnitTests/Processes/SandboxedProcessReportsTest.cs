...
namespace Test.BuildXL.Processes
{
    public class SandboxedProcessReportsTest : XunitBuildXLTest
    {
        ...
        public void TestParseFileAccessReportLineFencePost()
        {
            ...
            var ok = FileAccessReportLine.TryParse(ref line, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out _, out string error);
        ...
        private static void VerifyRead(string expectedPath, string line)
        {
            ...
            XAssert.AreEqual(false, isPathTruncated);
