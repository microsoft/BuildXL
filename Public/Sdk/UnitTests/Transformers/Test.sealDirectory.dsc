...
namespace Sdk.Tests {
    ...
    export function sealSealSourceDirectoryAllDirectoriesWithPatterns() {
        Transformer.sealSourceDirectory(d`src`, Transformer.SealSourceDirectoryOption.allDirectories, ["aTag", "zTag"], "description", ["*.cs", ".txt"]);
    }
    
    @@Testing.unitTest()
    export function sealSealSourceDirectoryTopDirectoryOnlyWithPatterns() {
        Transformer.sealSourceDirectory(d`src`, Transformer.SealSourceDirectoryOption.topDirectoryOnly, ["aTag", "zTag"], "description", ["*.cs", ".txt"]);
    }
