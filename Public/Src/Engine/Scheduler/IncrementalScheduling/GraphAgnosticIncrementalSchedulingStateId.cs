...
namespace BuildXL.Scheduler.IncrementalScheduling
{
    ...
    public sealed class GraphAgnosticIncrementalSchedulingStateId : IEquatable<GraphAgnosticIncrementalSchedulingStateId>
    {
        ...
        private readonly PreserveOutputsSalt m_preserveOutputSalt;
        ...
        private GraphAgnosticIncrementalSchedulingStateId(
            ...
            string substSource,
            string substTarget,
            PreserveOutputsSalt preserveOutputSalt)
        {
        ...
        /// </summary>
        public static GraphAgnosticIncrementalSchedulingStateId Create(PathTable pathTable, IConfiguration configuration, PreserveOutputsSalt preserveOutputSalt)
        {
        ...
        public static GraphAgnosticIncrementalSchedulingStateId Deserialize(BuildXLReader reader)
        {
            ...
            var preserveOutputSalt = new PreserveOutputsSalt(reader);
