...
namespace Test.BuildXL.TestUtilities
{
    ...
    public readonly struct Paths
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method is intended for debugging purposes only. Using this method in a transformer will lead to absolute paths
        /// leaking in textual form within the transformer's internal state and potentially within a pip's command-line. When
