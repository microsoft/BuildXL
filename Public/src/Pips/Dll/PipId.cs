...
namespace BuildXL.Pips
{
    ...
    public readonly struct PipId : IEquatable<PipId>
    {
        ...
        /// </summary>
        public uint Value => m_encoded & ((1U << ValueBits) - 1);
        ...
        public PipId(uint value)
        {
            ...
            Contract.Requires(value < (1U << ValueBits));
            m_encoded = value;
        }

        /// <summary>
        /// Indicates if this Pip ID and the one given represent the same underlying value. 
        /// </summary>
