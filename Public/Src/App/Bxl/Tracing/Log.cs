    ...
    public abstract partial class Logger
    {
        ...
        [GeneratedEvent(
            ...
            Message = "Performance Summary:\r\n" +
                        ...
                        "Factors limiting concurrency by build time: CPU:{limitingResourcePercentages.CPU}%, Graph Shape:{limitingResourcePercentages.GraphShape}%, Disk:{limitingResourcePercentages.Disk}%, Memory:{limitingResourcePercentages.Memory}%, Projected Memory:{limitingResourcePercentages.ProjectedMemory}%, Semaphore:{limitingResourcePercentages.Semaphore}%, Concurrency Limit:{limitingResourcePercentages.ConcurrencyLimit}%, Other:{limitingResourcePercentages.Other}%")]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Warning,
            Message = "Current host system is running an unsupported Linux distribution: '{currentDistribution}'. BuildXL currently supports the following Linux distributions {supportedDistributions}.",
            Keywords = (int)Keywords.UserMessage)]
        public abstract void IncompatibleLinuxDistroVersionDetected(LoggingContext context, string currentDistribution, string supportedDistributions);
