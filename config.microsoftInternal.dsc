...
const artifactNugetVersion = "19.224.33830-buildid20442787";
const azureDevopsNugetVersion = "19.224.0-internal202306303";
...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "ArtifactServices.App.Shared.Cache", version: artifactNugetVersion, dependentPackageIdsToSkip: ["*"], dependentPackageIdsToIgnore: ["Microsoft.BuildXL.Cache.Hashing", "Microsoft.BuildXL.Cache.Interfaces", "Microsoft.BuildXL.Cache.Libraries", "Microsoft.BuildXL.Utilities", "DotNetFxRefAssemblies.Corext", "System.Data.SQLite.Core"] },
    { id: "Drop.App.Core", version: artifactNugetVersion, dependentPackageIdsToSkip: ["*"], dependentPackageIdsToIgnore: ["Microsoft.BuildXL.Cache.Hashing", "Microsoft.BuildXL.Cache.Interfaces", "Microsoft.BuildXL.Cache.Libraries", "Microsoft.BuildXL.Utilities", "DotNetFxRefAssemblies.Corext", "System.Data.SQLite.Core"] },
    ...
    { id: "Microsoft.VisualStudio.Services.BlobStore.Client.Cache", version: artifactNugetVersion, dependentPackageIdsToSkip: ["*"], dependentPackageIdsToIgnore: ["Microsoft.BuildXL.Cache.Hashing", "Microsoft.BuildXL.Cache.Interfaces", "Microsoft.BuildXL.Cache.Libraries", "Microsoft.BuildXL.Utilities", "DotNetFxRefAssemblies.Corext"] },
    ...
    // SBOM Generation
    { id: "Microsoft.SBOMCore", version: "4.0.5" },
    { id: "Microsoft.Parsers.ManifestGenerator", version: "3.8.11", dependentPackageIdsToIgnore: ["BuildXL.Cache.Hashing"] },
    { id: "Microsoft.Sbom.Parsers.Spdx22SbomParser", version: "2.2.2" },
    { id: "Microsoft.Sbom.Adapters", version: "2.2.2" },
    { id: "Microsoft.ComponentDetection.Contracts", version: "4.0.11" },
    { id: "Microsoft.Sbom.Contracts", version: "2.2.2" },
    { id: "Microsoft.Sbom.Extensions", version: "2.2.2", dependentPackageIdsToSkip: ["System.Text.Json"] },
