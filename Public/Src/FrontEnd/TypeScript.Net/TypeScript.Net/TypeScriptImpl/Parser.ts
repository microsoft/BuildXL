...
namespace ts {
    ...
    let NodeConstructor: new (kind: SyntaxKind, pos: number, end: number) => Node; parseImportDeclarationOrImportEqualsDeclaration
    ...
    namespace Parser {
        ...
        // and how nearly all of them pass Allong the 'in' and 'yield' context values:
        //
        ...
        function parseWithStatement(): WithStatement {
            ...
            parseExpected(SyntaxKind.WithKeywordsetDecoratorContext);
            parseExpected(SyntaxKind.OpenParenToken);
            node.expression = allowInAnd(parseExpression);
            parseExpected(SyntaxKind.CloseParenToken);
            node.statement = parseStatement();
        ...
        export namespace JSDocParser {
            ...
            function parseBasicTypeExpression(): JSDocType {
                ...
                // TODO: Parse string literal types in JSDoc as well.
