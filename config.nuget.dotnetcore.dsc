...
const core80Version = "8.0.30";
const core90Version = "9.0.19";
const core100Version = "10.0.11";
...
export const pkgs = [
    ...
    // .NET Core osx-arm64 host dependencies shared by .NET 9 and .NET 10
    ...
    // (latest published is 8.0.30), so net10 reuses the existing .8.0 aliases registered above (same approach as net9).
    ...
    { id: "System.Formats.Asn1", version: "10.0.10"},
    ...
    { id: "System.Text.Json", version: "10.0.8" },
    ...
    { id: "System.Collections.Immutable", version: "10.0.11" },
