...
namespace BuildXL.Cache.ImplementationSupport
{
    ...
    /// </summary>
    public sealed class ProduceFileActivity : CacheActivity
    {
        /// <summary>
        ...
        public ProduceFileActivity(EventSource eventSource, Guid relatedActivityId, ICacheReadOnlySession cache)
            : base(
                eventSource,
                new EventSourceOptions
                {
                    Level = EventLevel.Informational,
                    Keywords = Keywords.TelemetryKeyword | Keywords.ProduceFile,
                },
                relatedActivityId,
                InterfaceNames.ProduceFile,
                cache.CacheId)
        {
        }
        ...
        /// </summary>
        public void Start(CasHash hash, string filename, FileState fileState, UrgencyHint urgencyHint)
        {
            Start();
