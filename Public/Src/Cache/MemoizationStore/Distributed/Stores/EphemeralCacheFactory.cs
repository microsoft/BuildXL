...
public static partial class EphemeralCacheFactory
{
    ...
    /// Creates a P2P cache.
    /// </summary>
    public static Task<CreateResult> CreateAsync(
        OperationContext context,
        Configuration configuration,
        AzureBlobStorageCacheFactory.CreateResult persistentCache,
        IClock? clock = null,
        IContentStore? backingLocalContentStore = null)
    {
        ...
        {
            DatacenterWideCacheConfiguration datacenterWideCacheConfiguration => CreateDatacenterWideCacheAsync(context, datacenterWideCacheConfiguration, persistentCache, clock, backingLocalContentStore),
            BuildWideCacheConfiguration buildWideCacheConfiguration => CreateBuildWideCacheAsync(context, buildWideCacheConfiguration, persistentCache, clock, backingLocalContentStore),
    ...
    private static async Task<CreateResult> CreateDatacenterWideCacheAsync(
        ...
        AzureBlobStorageCacheFactory.CreateResult persistentCache,
        IClock clock,
        IContentStore? backingLocalContentStore)
    {
        ...
        return await CreateInternalAsync(
            ...
            clock: clock,
            backingLocalContentStore: backingLocalContentStore);
    }
        ...
        IContentStore? backingLocalContentStore)
    {
        ...
        contentStoreSettings.DeleteOnShutdown = configuration.DeleteLocalOnShutdown;
        ...
        IContentStore getContentStore()
        {
            ...
            if (backingLocalContentStore != null)
            {
                return new BackedFileSystemContentStore(
                    PassThroughFileSystem.Default,
                    contentStore,
                    backingContentStore: backingLocalContentStore);
            }
            else
            {
                return contentStore;
