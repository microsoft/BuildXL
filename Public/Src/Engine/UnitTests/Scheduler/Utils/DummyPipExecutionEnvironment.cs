...
namespace Test.BuildXL.Scheduler.Utils
{
        ...
        IDisposable
    {
            ...
            ISandboxConnection sandboxConnection = null)
        {
            ...
            {
                preserveOutputsSalt = new PreserveOutputsSalt(ContentHashingUtilities.HashString(Guid.NewGuid().ToString()), config.Sandbox.UnsafeSandboxConfiguration.PreserveOutputsTrustLevel);
            }
