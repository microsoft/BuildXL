...
namespace BuildXL.Cache.ContentStore.App
{
    internal sealed partial class Application
    {
        ...
        internal void DistributedService
            ...
            [DefaultValue(false)] bool supportsCompression
            )
        {
            Initialize();
            ...
            try
            {
                ...
                var arguments = CreateDistributedCacheServiceArguments(
                    copier: useDistributedGrpc ? new GrpcFileCopier(new Interfaces.Tracing.Context(_logger), grpcPort, supportsCompression) : (IAbsolutePathFileCopier)new DistributedCopier(),
