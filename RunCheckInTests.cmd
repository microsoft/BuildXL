...
:PartB
    ...
    call :StatusMessage !stepName!
        ...
        call :RunBxl -Use RunCheckinTests -minimal -DeployRuntime net472 %BUILDXL_ARGS% /incrementalScheduling- /TraceInfo:RunCheckinTests=CompareFingerprints2 /logsDirectory:!COMPARE_FINGERPRINTS_LOGS_DIR! -SharedCacheMode disable /logPrefix:!SECOND_PREFIX! /cachegraph- /enableIncrementalFrontEnd-
        if !ERRORLEVEL! NEQ 0 (exit /b 1)
