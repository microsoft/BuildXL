...
.\bxl -Minimal -DeployConfig Release /q:Release /q:ReleaseLinux /q:ReleaseDotNet5 /q:ReleaseDotNetCoreMac /p:[BuildXL.Branding]SemanticVersion=$version /p:[BuildXL.Branding]SourceIdentification='1'
