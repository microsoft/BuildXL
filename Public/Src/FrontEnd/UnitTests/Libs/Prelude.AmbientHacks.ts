...
namespace _PreludeAmbientHack_Json {
    ...
    export declare function read<T>(jsonString: string): T;
}
...
namespace _PreludeAmbientHack_Transformer {
    ...
    export declare function getSharedOpaqueSubDirectory(directory: any, subDirectory: any, directoryFilteringRegexExpression?: any): SharedOpaqueDirectory;
