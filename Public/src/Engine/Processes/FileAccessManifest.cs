...
namespace BuildXL.Processes
{
    ...
    public sealed class FileAccessManifest
    {
        ...
        /// <summary>
        /// Determines whether BuildXL will collect process execution data (kernel\user mode time and IO counts)
        /// </summary>
        ...
        /// <summary>
        /// If true, crash when OOM happens in CBSS process.
        /// </summary>
        ...
        private void WriteFlagsBlock(BinaryWriter writer)
        {
            ...
            FileAccessManifestFlag flags =
                ...
                | (CrashOnCBSSOOMError ? FileAccessManifestFlag.CrashOnCBSSOOMError : 0)
        ...
        private static void WriteReportBlock(BinaryWriter writer, FileAccessSetup setup)
        {
            ...
            if (!string.IsNullOrEmpty(setup.ReportPath))
            {
                ...
                {
                    var report = new PaddedByteString(Encoding.Unicode, setup.ReportPath);
