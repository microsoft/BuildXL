...
namespace BuildXL.Native.IO
{
    ...
    public readonly struct OpenFileResult : IEquatable<OpenFileResult>
    {
        ...
        /// </remarks>
        public static OpenFileResult Create(int nativeErrorCode, FileMode creationDisposition, bool handleIsValid, bool openingById)
        {
            ...
            return new OpenFileResult(status, nativeErrorCode, openedOrTruncatedExistingFile);
        }
