...
debugprint "Required packages:"
    case "$operatingSystem" in
        "ubuntu")            
            ...
            installPackages "build-essential" "libc6-dev" "openssh-server" "curl" "dotnet-sdk-9.0" "libelf1" "libelf-dev" "zlib1g-dev" "git" "clang" "libnuma-dev"
        ;;
        "mariner" | "azurelinux")
            installPackages "rsync" "glibc-static.x86_64" "time" "dotnet-sdk-9.0" "clang" "elfutils-libelf" "elfutils-libelf-devel" "zlib-devel" "libnuma-devel"
        ;;
    esac
