...
const artifactNugetVersion = "18.170.30107-buildid12084297";
const azureDevopsNugetVersion = "16.170.0-internal202005071";
...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "CB.QTest", version: "20.5.13.181637", osSkip: [ "macOS", "unix" ] },
    ...
    { id: "GVFS.Installers", version: "1.0.20099.1" },
