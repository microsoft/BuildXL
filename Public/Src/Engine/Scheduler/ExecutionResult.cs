...
namespace BuildXL.Scheduler
{
    ...
    public sealed class TwoPhaseCachingInfo
    {
        ...
        public TwoPhaseCachingInfo(WeakContentFingerprint weakFingerprint, ContentHash pathSetHash, StrongContentFingerprint strongFingerprint, CacheEntry cacheEntry)
        {
        ...
        {
            return I($"WF:{WeakFingerprint}, PS#:{PathSetHash}, SF:{StrongFingerprint}, MD#:{CacheEntry.MetadataHash}");
        }
