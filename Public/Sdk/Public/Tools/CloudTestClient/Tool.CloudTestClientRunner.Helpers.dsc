    ...
    export function generateSessionConfig(args: GenerateSessionConfigArguments): GenerateSessionConfigResult {
        ...
        const sessionInput = {
            ...
            ado: isAdo ? {
                ...
                stageAttempt: Environment.getStringValue("SYSTEM_STAGEATTEMPT"),
                phaseName: Environment.getStringValue("SYSTEM_PHASENAME"),
                phaseAttempt: Environment.getStringValue("SYSTEM_PHASEATTEMPT"),
                jobName: Environment.getStringValue("SYSTEM_JOBNAME"),
                jobAttempt: Environment.getStringValue("SYSTEM_JOBATTEMPT"),
