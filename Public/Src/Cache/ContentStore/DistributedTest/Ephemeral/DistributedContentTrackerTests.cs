...
public class DistributedContentTrackerTests
{
    ...
    private class TestInstance : StartupShutdownComponentBase
    {
        ...
        private readonly GrpcCoreServerHostConfiguration _grpcConfiguration;
            ...
            IContentStore contentStore)
        {
            ...
            _grpcConfiguration = new GrpcCoreServerHostConfiguration()
                               {
                                   GrpcPort = _port,
                               };
        ...
        {
            await _initializer.StartAsync(context, _grpcConfiguration, new[] { _endpoint }).ThrowIfFailureAsync();
        ...
        {
            await _initializer.StopAsync(context, _grpcConfiguration).ThrowIfFailureAsync();
