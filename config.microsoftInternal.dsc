...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "Microsoft.Sbom.Parsers.Spdx22SbomParser", version: "2.2.8" },
    { id: "Microsoft.Sbom.Adapters", version: "2.2.8" },
    { id: "Microsoft.ComponentDetection.Contracts", version: "4.9.6" },
    { id: "Microsoft.Sbom.Contracts", version: "2.2.8" },
    { id: "Microsoft.Sbom.Extensions", version: "2.2.8" },
