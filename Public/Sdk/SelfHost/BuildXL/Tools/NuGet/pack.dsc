...
function getNugetPackerToolForCurrentOs() : Transformer.ToolDefinition {
    switch (Context.getCurrentHost().os) {
        case "win":
            return NugetPacker.withQualifier({targetFramework: "net10.0", targetRuntime: "win-x64", configuration: "release"}).tool;
        case "macOS":
            return NugetPacker.withQualifier({targetFramework: "net10.0", targetRuntime: "osx-x64", configuration: "release"}).tool;
        case "unix":
            return NugetPacker.withQualifier({targetFramework: "net10.0", targetRuntime: "linux-x64", configuration: "release"}).tool;
        default:
