...
namespace BuildXL.Native.IO
{
    ...
    public interface IFileUtilities
    {
        ...
        /// <summary>
        /// Whether the Posix file delete attempt should be skipped; Posix delete is normally the first attempt at file deletion
        /// Note: This should only be true for testing, since we want to be able to mimic customers OSes that do not support Posix deletes
        /// </summary>
        bool SkipPosixDelete { get; set; }
