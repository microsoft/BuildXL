...
namespace Test.BuildXL.Storage
{
    ...
    // This test requires fix on Detours concerning preservation of error code on CreateFileW.
    // Identical tests are kept in Test.BuildXL.Storage.Untracked so that the tests are still exercised
    // on Windows although not Detoured.
    ...
    public class FileContentTableExtensionsTests : TemporaryStorageTestBase
    {
        ...
        public FileContentTableExtensionsTests()
        {
