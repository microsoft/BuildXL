...
/// TODO: Remove this implementation and <see cref="IWriteBehindEventStorage"/>. See: https://mseng.visualstudio.com/1ES/_workitems/edit/2066339
///
/// WriteBehind layout:
///     logId.bin -> Log
...
/// </summary>
public class ContentMetadataEventStreamV0 : StartupShutdownComponentBase, IContentMetadataEventStream
{
    protected override Tracer Tracer { get; } = new Tracer(nameof(ContentMetadataEventStreamV0));
    ...
    public ContentMetadataEventStreamV0(
