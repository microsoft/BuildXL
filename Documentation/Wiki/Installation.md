...
### Acquire the plugin
You can build it locally with this command:
`bxl out\bin\debug\ide\`
And find the resulting file at: out\bin\debug\ide\BuildXL.vs.vsix

You can install it by simply running the vsix.
