...
namespace BuildXL.Cache.ImplementationSupport
{
    ...
    /// </summary>
    public sealed class PinToCasMultipleActivity : CacheActivity
    {
        /// <summary>
        ...
        public PinToCasMultipleActivity(EventSource eventSource, Guid relatedActivityId, ICacheReadOnlySession cache)
            : base(
                eventSource,
                ...
                relatedActivityId,
                InterfaceNames.PinToCasMultiple,
                cache.CacheId)
        {
        }
