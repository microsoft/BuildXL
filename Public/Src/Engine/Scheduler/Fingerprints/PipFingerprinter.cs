...
namespace BuildXL.Scheduler.Fingerprints
{
    ...
    public abstract class PipFingerprinter
    {
        ...
        private readonly ExpandedPathDirectoryArtifactComparer m_expandedPathDirectoryArtifactComparer;
        private readonly ExpandedPathFileArtifactWithAttributesComparer m_expandedPathFileArtifactWithAttributesComparer;
            ...
            PipDataLookup pipDataLookup = null)
        {
            ...
            m_expandedPathDirectoryArtifactComparer = new ExpandedPathDirectoryArtifactComparer(m_pathTable.ExpandedPathComparer, pathOnly: false);
            m_expandedPathFileArtifactWithAttributesComparer = new ExpandedPathFileArtifactWithAttributesComparer(m_pathTable.ExpandedPathComparer, pathOnly: false);
        }
        ...
        protected virtual void AddWeakFingerprint(IFingerprinter fingerprinter, SealDirectory sealDirectory)
        {
            ...
            // Sort the contents based on their members' expandend paths so that they are stable accross different path tables.
        ...
        protected virtual void AddWeakFingerprint(IFingerprinter fingerprinter, Process process)
        {
            ...
            fingerprinter.AddOrderIndependentCollection<DirectoryArtifact, ReadOnlyArray<DirectoryArtifact>>("DirectoryDependencies", process.DirectoryDependencies, (fp, d) => AddDirectoryDependency(fp, d), m_expandedPathDirectoryArtifactComparer);
            ...
            fingerprinter.AddOrderIndependentCollection<DirectoryArtifact, ReadOnlyArray<DirectoryArtifact>>("DirectoryOutputs", process.DirectoryOutputs, (h, p) => h.Add(p.Path), m_expandedPathDirectoryArtifactComparer);
