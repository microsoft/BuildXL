...
const qTestVersion = "26.8.19-g080a1e95";
...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "CB.QTest", version: qTestVersion, osSkip: [ "macOS", "unix" ] },
    { id: "CB.QTestLinux", version: qTestVersion, osSkip: [ "macOS"  ] },
    ...
    { id: "Microsoft.ComponentDetection.Contracts", version: "7.1.13", dependentPackageIdsToSkip: ["System.Threading.Tasks.Dataflow"] },
    ...
    { id: "Microsoft.VisualStudio.Services.Governance.ComponentDetection", version: "2026.8.27.1757", dependentPackageIdsToSkip: ["*"], osSkip: [ "macOS", "unix" ] },
