...
declare function configure(config: any): void;
declare function package(packageConfig: any): void;
declare function glob(root: string, pattern: string, depth?: number): void;
declare function importFrom(s: string): any;
declare function importFile(s: string): any;
