...
namespace BuildXL.Utilities.Configuration
{
    ...
    public interface ISandboxConfiguration
    {
        ...
        /// <summary>
        /// Break into the debugger when a tool accesses a file that was not declared in the specification dependencies. This option is useful when developing new tools or
        /// transformers using these tools. Defaults to off.
        /// </summary>
        ...
        /// <summary>
        /// Whether timestamps are normalized for processes to see when they read files. If false, reads will see the actual
        ...
        /// <summary>
        /// Whether to use use larger NtClose prealocated list.
        /// </summary>
        bool UseLargeNtClosePreallocatedList { get; }

        /// <summary>
        /// Whether to use extra thread to drain NtClose handle List or clean the cache directly.
        /// </summary>
        ...
        /// <summary>
        /// Whether to crash when CBSS gets OOM error.
        /// </summary>
        bool CrashOnCBSSOOMError { get; }
        ...
        /// <summary>
        /// Number of worker threads that drain the report queues filled by the kernel extension on macOS based systems
        /// </summary>
