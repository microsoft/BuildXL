...
| PipUsageMLMode | Controls Pip Usage ML evaluation: Disabled, Cold, or ColdAndWarm. Defaults to Disabled. Requires an internal build with compatible model resources. |
