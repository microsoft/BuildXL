...
namespace BuildXL.Utilities.Tracing
{
    ...
    public class CounterCollection
    {
        ...
        private static void AddToCounter(long[,] counters, ushort counterId, long add)
        {
            ...
            {
                // TODO: The .NET Core 2.1 release will expose GetCurrentProcessorId, which we can use here, see https://github.com/dotnet/corefx/issues/16767
                // Right now, we alias everything to the same processor ID
                processorId = 0;
            }
            else
            {
        ...
        where TEnum : struct
    {
        ...
        private static readonly CounterType[] s_counterTypes = GetCounterTypes();
        ...
        public Counter this[TEnum counterId]
        {
            get
            {
                ...
                return new Counter(this, counterIndex, s_counterTypes[counterIndex]);
            }
        }
        ...
        private static CounterType[] GetCounterTypes()
        {
