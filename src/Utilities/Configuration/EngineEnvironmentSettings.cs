...
namespace BuildXL.Utilities.Configuration
{
    ...
    public static class EngineEnvironmentSettings
    {
        ...
        /// <summary>
        /// The location of the BuildXL enlistment when the Visualizer is in dev mode.
        /// </summary>
        public static readonly Setting<string> BuildXLVisualizerDevModePath = CreateSetting("BuildXLVisualizerDevModePath", value => value);
        ...
        //// <summary>
        //// Connect timeout
        // TODO: The current Bond implementation does not provide an easy way to hook the call timeouts.
        // Keeping the commented property to remind us of the problem.
        // We can fix the issue by either converting to WCF or by manually implementing all methods needed by the proxy.
        //// </summary>
        // internal static readonly Setting<TimeSpan> DistributionCallTimeout = CreateSetting("BuildXLDistribCallTimeoutSec", value => ParseTimeSpan(value, ts => TimeSpan.FromSeconds(ts)) ??
        //    TimeSpan.FromSeconds(30));
...
#pragma warning restore CA2211 // Non-constant fields should not be visible
            ...
            public static string GetVariable(string name, out int version)
            {
                string value;
                version = Version;
                s_variables.TryGetValue(name, out value);
                return value;
            }
