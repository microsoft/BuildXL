...
namespace Test.BuildXL.TestUtilities.XUnit.Extensions
{
    ...
    /// </summary>
    internal sealed class DelegatingMessageBus : global::Xunit.Sdk.DelegatingMessageBus
    {
        private Logger Logger { get; }

        /// <nodoc />
        public DelegatingMessageBus(Logger logger, IMessageBus innerMessageBus, Action<IMessageSinkMessage> callback = null)
