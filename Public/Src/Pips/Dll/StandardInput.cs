...
namespace BuildXL.Pips
{
    ...
    public readonly struct StandardInput : IEquatable<StandardInput>
    {
        ...
        /// <summary>
        /// Serializes this standard input.
        /// </summary>
        internal void InternalSerialize(PipWriter writer)
        {
            writer.Write(File);
        ...
        /// <summary>
        /// Deserializes into a standard input.
        /// </summary>
        internal static StandardInput InternalDeserialize(PipReader reader)
        {
            FileArtifact file = reader.ReadFileArtifact();
