...
namespace BuildXL.FrontEnd.Script.Tracing
{
    ...
    public abstract partial class Logger : LoggerBase
    {
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "{exceptionMessage}.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.UserError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Unexpected exception: {exceptionMessage}.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Invalid package name {name} (case insensitive) because the name is reserved.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.UserError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Specified package file '{packagePath}' is not within the configuration directory '{configFilePath}'.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.UserError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Specified package (configuration) file '{packageConfigPath}' does not exist.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.UserError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Configuration in '{configPath}' does not evaluate to an object literal.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.UserError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Unable to perform type checking because no type checker is set for the front end.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Informational,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Debug CallStack: {message}:\r\n{stackTrace}",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            Message = Events.LabeledProvenancePrefix + "Cannot specify 'modules' and 'packages' at the same time in '{pathToConfig}'. Field 'packages' is obsolete, please use 'modules' instead.")]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Selector '{selector}' cannot be applied to receiver '{receiver}' in expression '{receiver}.{selector}' because receiver is of type 'any'. Values with type 'any' cannot be inspected in {ShortScriptName}.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.UserError))]
