...
call %PRROOT%\Utilities\RunBxl.cmd "-Use RunCheckInTests -All /logOutput:FullOutputOnError /p:RetryXunitTests=1 /processRetries:3 /q:DebugDotNetCore /q:ReleaseDotNetCore /q:DebugDotNetCoreMac /q:ReleaseDotNetCoreMac /p:FeatureUploadSymbolsAndDrops=1 /TraceInfo:RunCheckinTests=NewBits"
if %ERRORLEVEL% NEQ 0 (
