...
namespace BuildXL.Cache.MemoizationStore.VstsTest
{
    ...
    public class DistributedWriteThroughBuildCacheSimulationTests : WriteThroughBuildCacheSimulationTests
    {
        public DistributedWriteThroughBuildCacheSimulationTests()
            : this(StorageOption.Item)
        {
        }

        protected DistributedWriteThroughBuildCacheSimulationTests(StorageOption storageOption)
            : base(storageOption)
        {
        }
            ...
            TimeSpan? expiryRange = null)
        {
            ...
            return TestDistributedCacheFactory.CreateCache(
                logger, innerCache, cacheNamespace, nameof(DistributedWriteThroughBuildCacheSimulationTests), ReadThroughMode.None);
        }
    }
}
