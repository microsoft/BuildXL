...
export interface SymbolRunner {
     ...
     */
    addFilesToSymbol: (createResult: SymbolCreateResult, args: OperationArguments, fileInfos: File[], clientKeys?: string[], customClientKeyPrefixEnvVariable?: string, tags?: string[]) => Result;

    /**
     * Indexes and publishes files withing the specified directories.
     */
    addDirectoriesToSymbol: (createResult: SymbolCreateResult, args: OperationArguments, directories: StaticDirectory[], directoryContentFilter?: string[], directoryPathToClientKeys?: string[], customClientKeyPrefixEnvVariable?: string, tags?: string[]) => Result;
