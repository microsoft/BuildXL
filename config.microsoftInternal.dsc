...
const artifactNugetVersion = "19.207.32627-buildid17546194";
const azureDevopsNugetVersion = "16.207.0-internal202206272";
...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "CB.QTest", version: "22.4.8.191607", osSkip: [ "macOS", "unix" ] },
