...
namespace BuildXL.Cache.Monitor.App.Notifications
{
    internal class Notification
    {
        ...
        public Notification(string ruleIdentifier, Guid ruleRunGuid, DateTime ruleRunTimeUtc, DateTime creationTimeUtc, DateTime eventTimeUtc, string bucket, Severity severity, Env environment, string stamp, string message, string summary = null)
        {
            Contract.RequiresNotNullOrEmpty(ruleIdentifier);
            Contract.RequiresNotNullOrEmpty(bucket);
