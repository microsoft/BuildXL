...
namespace BuildXL.Cache.ContentStore.Stores
{
    ...
    public class ReadOnlyEmptyContentStore : StartupShutdownBase, IContentStore
    {
        ...
        /// <inheritdoc />
        Task<DeleteResult> IContentStore.DeleteAsync(Context context, ContentHash contentHash, bool allowWait) => Task.FromResult(new DeleteResult($"{nameof(ReadOnlyEmptyContentStore)} cannot contain any content to delete"));
