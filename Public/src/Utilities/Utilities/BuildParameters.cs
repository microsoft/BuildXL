...
namespace BuildXL.Utilities
{
    ...
    public static class BuildParameters
    {
        ...
        /// <summary>
        /// Name of the (pseudo-)environment variable indicating if the build is running 'elevated' or not.
        /// </summary>
        ...
        public sealed class Factory
        {
            ...
            ///     variables (<see cref="DisallowedTempVariables"/>), plus a special pseudo-variable
