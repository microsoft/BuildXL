...
public sealed class GrpcCacheServer : GrpcContentServer
{
    ...
    /// <nodoc />
    public Task<AddOrGetContentHashListResponse> AddOrGetContentHashListAsync(AddOrGetContentHashListRequest request, ServerCallContext context)
    {
    ...
    /// <nodoc />
    public Task<GetContentHashListResponse> GetContentHashListAsync(GetContentHashListRequest request, ServerCallContext context)
    {
        return PerformOperationAsync(
            request,
            async c =>
    ...
    /// <nodoc />
    public Task<GetSelectorsResponse> GetSelectorsAsync(GetSelectorsRequest request, ServerCallContext context)
    {
        return PerformOperationAsync(
            request,
            async c =>
    ...
    /// <nodoc />
    public Task<IncorporateStrongFingerprintsResponse> IncorporateStrongFingerprints(IncorporateStrongFingerprintsRequest request, ServerCallContext context)
    {
        return PerformOperationAsync(
            request,
            async c =>
