...
{
    /// <summary>
    /// Provides methods for matching file system names. BuildXL code uses Win32 pattern expressions for
    /// directory enumeration filtering and others. This code is in place to keep the BuildXL code base as-is
    /// and allow for the same pattern expressions being used on Unix systems.
    /// </summary>
