...
namespace Test.BuildXL.Processes.Detours
{
    public sealed partial class SandboxedProcessPipExecutorTest
    {
        ...
        public async Task MissingFileAccessForOutput(bool preserveOutputs)
        {
            ...
            using (var tempFiles = new TempFileStorage(canGetFileNames: true, rootPath: TemporaryDirectory))
            {
                ...
                else
                {
                    ...
                    AssertErrorEventLogged(loggingContext, EventId.PipProcessExpectedMissingOutputs);
                    AssertErrorEventLogged(loggingContext, EventId.PipProcessError);
                }
            }
        }
        ...
        public async Task ProcessUnexpectedFileAccess()
        {
            ...
            AssertVerboseEventLogged(loggingContext, EventId.PipProcessFinishedFailed);
            AssertErrorEventLogged(loggingContext, EventId.PipProcessError);
        ...
        public async Task ProcessFileTempDirectoryViolation()
        {
            ...
            AssertVerboseEventLogged(loggingContext, EventId.PipProcessDisallowedTempFileAccess);
        }
        ...
        public async Task ProcessFileTempDirectoryViolationReportedAsWarning()
        {
            ...
            AssertVerboseEventLogged(loggingContext, EventId.PipProcessDisallowedTempFileAccess, count: 3);
        }
        ...
        public async Task ProcessUnexpectedFileAccessWhitelistedByValue()
        {
            ...
            AssertInformationalEventLogged(loggingContext, EventId.PipProcessDisallowedFileAccessWhitelistedNonCacheable);
        }
        ...
        public async Task Timeout()
        {
            ...
            bool partialDetoursPayloadCopyError = false;
            ...
            if (partialDetoursPayloadCopyError)
            {
        ...
        public async Task PipRetry()
        {
            ...
            using (var tempFiles = new TempFileStorage(canGetFileNames: true, rootPath: TemporaryDirectory))
            {
                ...
                AssertVerboseEventLogged(loggingContext, EventId.RetryStartPipDueToErrorPartialCopyDuringDetours, SandboxedProcessPipExecutor.ProcessLaunchRetryCountMax);
            }
        ...
        {
            return AssertProcessCompletesWithStatus(SandboxedProcessPipExecutionStatus.ExecutionFailed, context, config, process, fileAccessWhitelist, resultWrapper, loggingContext: loggingContext);
        }
        ...
        private static Task AssertProcessFailsPreparation(
            ...
            LoggingContext loggingContext = null)
        {
            return AssertProcessCompletesWithStatus(SandboxedProcessPipExecutionStatus.PreparationFailed, context, config, process, fileAccessWhitelist, loggingContext: loggingContext);
        }
        ...
        private static Task AssertProcessSucceeds(
            ...
            LoggingContext loggingContext = null)
        {
            return AssertProcessCompletesWithStatus(SandboxedProcessPipExecutionStatus.Succeeded, context, config, process, fileAccessWhitelist, directoryArtifactContext: directoryArtifactContext, loggingContext: loggingContext);
        }
        ...
        private static async Task AssertProcessCompletesWithStatus(
            ...
            LoggingContext loggingContext = null)
        {
            SandboxedProcessPipExecutionResult result = await RunProcess(context, config, process, fileAccessWhitelist, new Dictionary<string, string>(), SemanticPathExpander.Default, directoryArtifactContext, loggingContext);
