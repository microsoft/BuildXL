...
#nullable enable
    ...
    public class OutOfProcCacheSettings
    {
        ...
        /// <summary>
        /// If specified, then the parent process will be using this name as the prefix for file logs generated by NLog.
        /// This config option should look like: "NLogConfigurationReplacements": { "CloudCache.": "CacheService."}
        /// </summary>
