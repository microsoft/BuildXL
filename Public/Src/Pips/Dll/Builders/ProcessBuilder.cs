...
namespace BuildXL.Pips.Builders
{
    ...
    public class ProcessBuilder : IDisposable
    {
        ...
        /// <nodoc />
        public ReadOnlyArray<int> UncacheableExitCodes { get; set; } = ReadOnlyArray<int>.Empty;
        ...
        public static ProcessBuilder Create(PathTable pathTable, PooledObjectWrapper<PipDataBuilder> argumentsBuilder, IBuildXLCredentialScanner credentialScanner, LoggingContext loggingContext)
        {
            ...
            return new ProcessBuilder(pathTable, argumentsBuilder, credentialScanner, loggingContext);
        }
        ...
        public bool TryFinish(PipConstructionHelper pipConstructionHelper, out Process process, out ProcessOutputs processOutputs)
        {
            ...
            process = new Process(
                ...
                allowedUndeclaredSourceReadScopes: AllowedUndeclareSourceReadScopes,
                allowedUndeclaredSourceReadPaths: AllowedUndeclareSourceReadPaths,
                allowedUndeclaredSourceReadRegexes: AllowedUndeclareSourceReadRegexes);
