...
namespace BuildXL.Engine.Tracing
{
    ...
    public abstract partial class Logger
    {
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Verbose,
            Message = Events.PhasePrefix + "Parsing files",
            EventTask = (ushort)Events.Tasks.Engine,
        ...
        [GeneratedEvent(
            ...
            Message = Events.PhasePrefix + "Done parsing {parseStatistics.FileCount} files in {parseStatistics.ElapsedMilliseconds} ms.",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalAndTelemetry,
            Message = Events.PhasePrefix + "Done evaluating values in {evaluateStatistics.ElapsedMilliseconds}ms. {evaluateStatistics.ValueCount} total values resolved, Full evaluation:{evaluateStatistics.FullEvaluation}.",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Verbose,
            Message = Events.PhasePrefix + "Starting execution",
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalAndTelemetry,
            Message = Events.PhasePrefix + "Done executing pips in {executeStatistics.ElapsedMilliseconds} ms.",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Checking for pip graph reuse",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventOpcode = (byte)EventOpcode.Start,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress),
            Message = Events.PhasePrefix + "Visiting spec files for graph reuse check")]
        ...
        [GeneratedEvent(
            ...
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress),
            Message = Events.PhasePrefix + "Done visiting {fileCount} spec files for graph reuse check in {elapsedMilliseconds}ms")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Engine,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress),
            Message = Events.PhasePrefix + "USN journal: No spec files are changed so graph in the engine cache is reusable")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Engine,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress),
            Message = Events.PhasePrefix + "USN journal: At least one spec file and/or one directory membership have changed: Spec file: {specFile} | Directory: {directory}")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Engine,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress),
            Message = Events.PhasePrefix + "USN journal statistics for graph reuse check: {message}")]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalAndTelemetry,
            Message = Events.PhasePrefix + "Done checking for pip graph reuse in {graphCacheCheckStatistics.ElapsedMilliseconds}ms. ObjectDirectoryMissReason:{graphCacheCheckStatistics.ObjectDirectoryMissReasonAsString}, CacheMissReason:{graphCacheCheckStatistics.CacheMissReasonAsString} ",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Checking input files for pip graph reuse. {done} done. {remaining} remaining.",
            EventLevel = Level.Informational,
            EventTask = (ushort)Events.Tasks.Engine,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress | Events.Keywords.Overwritable))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Reloading pip graph from previous build.",
            EventLevel = Level.Informational,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Reloading engine state from previous build.",
            EventLevel = Level.Informational,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress | Events.Keywords.Overwritable))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalAndTelemetry,
            Message = Events.PhasePrefix + "Done reloading engine state from previous build in {graphCacheReloadStatistics.ElapsedMilliseconds} ms.",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Decided to reuse engine context gen-{generation}. Reason: {reason}",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Decided NOT to reuse engine context gen-{generation}. Reason: {reason}",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            Message = Events.PhasePrefix + "Serializing pip graph for future reuse",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalAndTelemetry,
            Message = Events.PhasePrefix + "Done serializing pip graph for future reuse in {graphCacheSaveStatistics.ElapsedMilliseconds}ms. Serialization time {graphCacheSaveStatistics.SerializationMilliseconds}ms. Is success: {graphCacheSaveStatistics.Success}",
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Performance | Events.Keywords.Progress))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.CacheInteraction,
            EventOpcode = (byte)EventOpcode.Info,
            Keywords = (int)(Events.Keywords.Diagnostics | Events.Keywords.UserMessage))]
        ...
        [GeneratedEvent(
            ...
            // did fail.
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.NotForwardedToMaster),
            EventTask = (ushort)Events.Tasks.Distribution,
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Error,
            Keywords = (int)Events.Keywords.UserMessage | (int)Events.Keywords.InfrastructureError,
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Info,
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics | Events.Keywords.InfrastructureError))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Verbose,
            EventTask = (ushort)Events.Tasks.Engine,
            Keywords = (int)Events.Keywords.Performance)]
...
")]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)Events.Keywords.UserMessage,
            EventTask = (int)Events.Tasks.Engine,
            Message = Events.PhasePrefix + "Freezing environment")]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Progress | Events.Keywords.Overwritable),
            EventTask = (int)Events.Tasks.Engine,
            Message = Events.PhasePrefix + "Constructing pip graph. {0}")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + ScrubbingStatusPrefix)]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Scrubbing content from shared opaque directories.")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Scrubbing finished. Traversed {0} directories and checked {1} files. {2} files were deleted. {3} directories were deleted recursively.")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + ScrubbingStatusPrefix + " Files processed: {0} ")]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.UserError),
            EventTask = (int)Events.Tasks.Engine,
            Message = Events.ProvenancePrefix + "Mount has invalid name.")]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.UserError),
            EventTask = (int)Events.Tasks.Engine,
            Message = Events.ProvenancePrefix + "Mount '{3}' has invalid path.")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Cleaning build output files only. No pips will be executed in this build.")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Rehydrating configuration with new PathTable")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Done rehydrating configuration with new PathTable")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Loading running times")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Done loading running times")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Saving updated running times")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Done saving updated running times")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Initializing the cache")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Machine-wide cache lock acquired")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Parsing configuration files")]
        ...
        [GeneratedEvent(
            ...
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Done parsing configuration files")]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Informational,
            Keywords = (int)Events.Keywords.Diagnostics | (int)Events.Keywords.Progress,
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Start,
            Message = Events.PhasePrefix + "Run engine")]
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Informational,
            Keywords = (int)Events.Keywords.Diagnostics | (int)Events.Keywords.Performance | (int)Events.Keywords.Progress,
            EventTask = (int)Events.Tasks.Engine,
            EventOpcode = (byte)EventOpcode.Stop,
            Message = Events.PhasePrefix + "Done running engine")]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)Events.Keywords.Performance | (int)Events.Keywords.UserMessage
                ...
                | (int)Events.Keywords.Diagnostics,
            EventTask = (int)Events.Tasks.Engine,
        ...
        [GeneratedEvent(
            ...
            EventGenerators = EventGenerators.LocalOnly,
            EventLevel = Level.Verbose,
            Keywords = (int)Events.Keywords.Performance | (int)Events.Keywords.UserMessage | (int)Events.Keywords.Diagnostics,
            EventTask = (int)Events.Tasks.Engine,
      ...
      [GeneratedEvent(
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.UserError),
            EventTask = (int)Events.Tasks.Parser,
            Message = Events.ProvenancePrefix + "Related location of error in file '{3}' on line '{4}' at column '{5}'.")]
