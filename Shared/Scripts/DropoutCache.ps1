...
.\bxl -Minimal -DeployConfig Release /q:Release /q:ReleaseLinux /q:ReleaseDotNet5 /q:ReleaseDotNetCoreMac out\bin\release\cache\* /p:[BuildXL.Branding]SemanticVersion=$version /p:[BuildXL.Branding]SourceIdentification='1'
