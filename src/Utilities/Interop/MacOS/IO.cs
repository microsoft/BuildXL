...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public enum Errno : int
        {
            ...
            ELOOP = 65, // Too many levels of symbolic links
        }
        ...
        public struct Timespec
        {
            ...
            {
                return UnixEpoch.AddTicks(((Tv_sec * 1000000000) + Tv_nsec) / 100);
            }
        ...
        public unsafe struct Timestamps
        {
            /// <nodoc />
            public Timespec CreationTime;

            /// <nodoc />
            public Timespec ModificationTime;

            /// <nodoc />
            public Timespec AcessTime;
        ...
        /// <summary>
        /// Returns the creation, modification, change and access time of a file specified at path
        /// </summary>
        /// <returns>Returns zero in case of success, otherwise error</returns>
        [DllImport(Libraries.InteropLibMacOS, SetLastError = true)]
        public static extern unsafe int GetTimeStampsForFilePath(string path, bool followSymlinks, Timestamps* buffer);
        ...
        /// <returns>Returns zero in case of success, otherwise error</returns>
        [DllImport(Libraries.InteropLibMacOS, SetLastError = true)]
        public static extern unsafe int SetTimeStampsForFilePath(string path, bool followSymlink, Timestamps* buffer);

        /// <summary>
        /// Read the value of a symbolic link specified by <paramref name="link"/>
        /// Returns number of bytes placed in buf, and -1 otherwise.
        /// </summary>
        [DllImport(Libraries.InteropLibMacOS, SetLastError = true, CharSet = CharSet.Ansi)]
        public static extern long SafeReadLink(string link, StringBuilder buffer, long length);

        /// <summary>
        /// Gets the number of hard links for the entry at <paramref name="path"/>
        /// </summary>
        /// <returns>Returns zero in case of success, otherwise error</returns>
        [DllImport(Libraries.InteropLibMacOS, SetLastError = true)]
        public static extern unsafe int GetHardLinkCountForFilePath(string path, bool followSymlink = true);
        ...
        /// <returns>Returns zero in case of success, otherwise error</returns>
        [DllImport(Libraries.InteropLibMacOS, SetLastError = true)]
        public static extern unsafe int GetFilePermissionsForFilePath(string path, bool followSymlink = true);
        ...
        /// <summary>
        /// Creates and opens a file at specified path and sets the desired access rights.
        /// </summary>
        [DllImport(Libraries.LibC, SetLastError = true)]
        public static extern int openAndCreate(string pathname, int flags, FilePermissions permissions);
