...
export const pkgs = isMicrosoftInternal ? [
    ...
    { id: "Microsoft.ComponentDetection.Contracts", version: "5.2.21", dependentPackageIdsToSkip: ["System.Threading.Tasks.Dataflow"] },
    ...
    // CredScan
    { id: "Microsoft.Security.CredScan.ClientLib", version: "2.4.0" },
