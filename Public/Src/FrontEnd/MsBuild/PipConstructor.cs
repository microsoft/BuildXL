...
namespace BuildXL.FrontEnd.MsBuild
{
    ...
    internal sealed class PipConstructor
    {
            ...
            out string failureDetail)
        {
            ...
            processBuilder.SetGlobalPassthroughEnvironmentVariable(m_frontEndHost.Configuration.Sandbox.GlobalUnsafePassthroughEnvironmentVariables, m_context.StringTable);
