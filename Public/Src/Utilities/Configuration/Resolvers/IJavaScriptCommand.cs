...
{
    /// <summary>
    /// A JavaScript command where dependencies on other commands can be explicitly provided
    ...
    /// </summary>
    public interface IJavaScriptCommand : IJavaScriptCommandWithDependencies
    {
        /// <nodoc/>
        string Command { get; }
    }
