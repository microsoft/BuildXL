...
namespace BuildXL.FrontEnd.Nuget.Tracing
{
    ...
    public abstract partial class Logger
    {
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)Events.Keywords.UserMessage | (int)Events.Keywords.Overwritable)]
        ...
        [GeneratedEvent(
            ...
            Keywords = (int)Events.Keywords.UserMessage | (int)Events.Keywords.OverwritableOnly)]
