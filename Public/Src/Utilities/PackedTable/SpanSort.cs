...
{
    /// <summary>
    /// Sorting extension method for Span[T]
    /// </summary>
    /// <remarks>
    /// Duplicated from .NET 5 source since BuildXL is not yet running on .NET 5 which has this implementation built in.
    /// Once the BuildXL move to .NET 6 is complete, this can be deleted: https://dev.azure.com/mseng/1ES/_workitems/edit/1887601
    /// </remarks>
    public static class SpanSortExtension
    {
        /// <summary>
        /// Sort this Span.
        /// </summary>
        public static void Sort<T>(this Span<T> span, IComparer<T> comparer) => ArraySortHelper<T>.Sort(span, comparer);

        /// <summary>
        /// Sort this Span.
        /// </summary>
        public static void Sort<T>(this Span<T> span, Comparison<T> comparison) => ArraySortHelper<T>.Sort(span, comparison);

        /// <summary>
        /// Stubs generated by refactoring.
        /// </summary>
        private class ThrowHelper
        {
            internal static void ThrowArgumentException_BadComparer<T>(IComparer<T> _)
            {
                throw new ArgumentException("Bad comparer; sort algorithm failed due to inconsistent comparisons");
            }

            internal static void ThrowArgumentException_BadComparer<T>(Comparison<T> _)
            {
                throw new ArgumentException("Bad comparer; sort algorithm failed due to inconsistent comparisons");
            }

            internal static void ThrowInvalidOperationException(object _, Exception e)
            {
                throw new InvalidOperationException("Comparer threw exception, which should never happen", e); 
            }
        }

        /// <summary>
        /// Stub class generated by refactoring (never actually used in this copied implementation)
        /// </summary>
        private class ExceptionResource
        {
            public static object InvalidOperation_IComparerFailed { get; internal set; }
        }

        /// <summary>
        /// Copied from .NET 5 Array implementation
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Source: https://github.com/dotnet/runtime/blob/57bfe474518ab5b7cfe6bf7424a79ce3af9d6657/src/libraries/System.Text.Encodings.Web/src/Polyfills/System.Numerics.BitOperations.netstandard20.cs
        /// </remarks>
        private static class BitOperations
        {
            ...
            private static int Log2SoftwareFallback(uint value)
            {
                ...
                ref byte dir = ref MemoryMarshal.GetReference(Log2DeBruijn);
                nint offset;
                unchecked
                {
                    offset = (nint)((value * 0x07C4ACDDu) >> 27);
                }

                return Unsafe.AddByteOffset(ref dir, offset);
            }
        }
        ...
        /// <summary>
        /// Core sorting algorithm from .NET 5
        /// </summary>
        /// <remarks>
        /// Source: https://github.com/dotnet/runtime/blob/main/src/libraries/System.Private.CoreLib/src/System/Collections/Generic/ArraySortHelper.cs
        /// </remarks>
        private sealed partial class ArraySortHelper<T>
        {
            ...
            internal static void Sort(Span<T> keys, Comparison<T> comparer)
            {
                ...
                {
                    ThrowHelper.ThrowArgumentException_BadComparer<T>(comparer);
                }
                catch (Exception e)
                {
                    ThrowHelper.ThrowInvalidOperationException(ExceptionResource.InvalidOperation_IComparerFailed, e);
