...
static void checkReadNonexistent(PolicyResult policy, bool isDir, AccessCheckResult *checkResult)
{
...
CheckFunc Checkers::CheckReadNonexistent = checkReadNonexistent;
