...
namespace BuildXL.Cache.ImplementationSupport
{
    ...
    /// </summary>
    public sealed class AddToCasFilenameActivity : CacheActivity
    {
        /// <summary>
        ...
        public AddToCasFilenameActivity(EventSource eventSource, Guid relatedActivityId, ICacheReadOnlySession cache)
            : base(
                eventSource,
                ...
                relatedActivityId,
                InterfaceNames.AddToCasFilename,
                cache.CacheId)
        {
        }
