...
namespace BuildXL.Pips.Builders
{
    ...
    /// This object is wrapped inside a BuildXLScript object and handed out to users.
    /// </summary>
    public sealed class ProcessOutputs
    {
        ...
        /// <nodoc />
        public ProcessOutputs(Dictionary<AbsolutePath, FileArtifactWithAttributes> outputFileMap)
        {
