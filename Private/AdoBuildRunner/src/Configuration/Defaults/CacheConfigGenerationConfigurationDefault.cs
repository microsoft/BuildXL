...
namespace BuildXL.AdoBuildRunner
{
    ...
    public static class CacheConfigGenerationConfigurationDefaults
    {
        ...
        {
            var filePath = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? HostedPoolBuildCacheConfigurationFileForWindows : HostedPoolBuildCacheConfigurationFileForLinux;
