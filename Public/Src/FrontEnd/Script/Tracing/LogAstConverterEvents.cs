...
namespace BuildXL.FrontEnd.Script.Tracing
{
    ...
    public abstract partial class Logger
    {
        [GeneratedEvent(
            ...
            Message = Events.LabeledProvenancePrefix + "Failed to parse configuration: {message}",
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Failed to parse module configuration file: {message}",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Module configuration file is invalid. {message}.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Unexpected statement in module configuration file. Only a single call to '" +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The module configuration file must contain at least a single call to '" +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Duplicate binding for '{name}'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Configuration declaration '" + Names.ConfigurationFunctionCall +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Module configuration declaration '" + Names.ModuleConfigurationFunctionCall +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'{enumMember}' is invalid. A member of a constant enum must have an initializer that evaluates to a numeric value.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Local functions are not supported in DScript. Use lambda expressions instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Left-hand side of an assignment expression must be a local variable.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Imported file '{path}' is not referenced and will be removed.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The operand of an increment or decrement operator must be a local variable.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The configuration file '" + Names.ConfigBc +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Unexpected statement in configuration file '" +
                        Names.ConfigBc +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Configuration file '" + Names.ConfigBc + "' is invalid. {message}",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Path '{path}' is invalid.",
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Invalid relative path expression.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Invalid path atom expression.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Referenced project path '{path}' is invalid.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Referenced project '{moduleName}' contains invalid characters. The following characters are not allowed: {invalidCharacters}.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Failed to compute absolute path for '{path}'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Integral constant '{expression}' is too large.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Left-hand side of assignment expression '{expression}' cannot be a constant.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The operand of an increment or decrement operator cannot be a constant.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Arithmetic operation '{expression}' resulted in an overflow.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Invalid radix was specified for '{expression}'. Valid values are 2, 8, 10 or 16, but got {radix}",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Name '{name}' cannot be found.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Cannot capture enclosing variable '{name}' for mutation.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Block scoped variable '{variableName}' used before its declaration.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
