...
@@public
export type DotNetCoreVersion = "net6.0" | "net8.0" | "net9.0";

@@public
export function isDotNetCore(targetFramework: TargetFrameworks.AllFrameworks) : targetFramework is DotNetCoreVersion {
    return targetFramework === 'net6.0' || targetFramework === 'net8.0' || targetFramework === 'net9.0';
}
...
namespace TargetFrameworks {
    ...
    @@public
    export type CoreClrTargetFrameworks = "net6.0" | "net8.0" | "net9.0";
