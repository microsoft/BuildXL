...
namespace BuildXL.Engine
{
    ...
    public sealed class DynamicEngineSchedule : IEngineSchedule
    {
        ...
        EngineContext IEngineSchedule.Context => Context;
        ...
        bool IEngineSchedule.ExecuteScheduledPips(LoggingContext loggingContext, WorkerService workerService) =>
            ExecuteScheduledPips(loggingContext, workerService);
...
#region Serialization
        ...
        EngineState IEngineSchedule.GetOrCreateNewEngineState(EngineState previousEngineState) =>
            GetOrCreateNewEngineState(previousEngineState);
