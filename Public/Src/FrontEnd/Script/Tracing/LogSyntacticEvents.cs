...
namespace BuildXL.FrontEnd.Script.Tracing
{
    ...
    public abstract partial class Logger
    {
        ...
        [GeneratedEvent(
            ...
            Message = Events.LabeledProvenancePrefix + "Function applications without const/let bindings are not allowed as top level statements. The exceptions are '" + Names.ConfigurationFunctionCall +
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Top level declarations are constant. Use const binding to express this behavior.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Top level declarations should not be of mutable types. Mutable data structures are allowed only as an implementation detail for pure functions.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Public functions should not return mutable types.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Only type, function declarations and const binding are allowed as top level statements, but expression of type '{type}' was found.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Labels are not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'var' declarations are not allowed in DScript. Use 'const' or 'let' instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'throw' is not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'null' is not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The function 'eval' is not available in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Failed to read the content of '{fileToRead}': {details}",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Failed to serialize persist public facade or evaluation ast: {error}",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Syntax is obsolete. Use 'import * as ...' instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Warning,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Member '{member}' is obsolete.{message}",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'import * as' syntax is not supported in DScript V2.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Declarations are implicitly readonly in DScript. Please remove 'readonly' modifier from the declaration.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type value must be a string literal.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type  must have a valid value. '{value}' is not. ';' and '=' are not allowed.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type must have a valid qualifier key. '{key}' is not. ';' and '=' are not allowed.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type property cannot be a shorthand property assignment.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type must be a non-empty array literal.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Interpolation function '{interpolationFunction} is not allowed.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Symbol type is not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Default arguments are not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Method declaration '{member}' is not allowed in object literals.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "class declarations are not allowed in DScript.",
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "class expressions are not allowed in DScript.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'new' expressions are not allowed in DScript.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The 'from' clause of an import statement can only be a string literal, but '{moduleSpecifier}' was found.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Method 'importFrom' can only be passed a string literal, but '{moduleSpecifier}' was found.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Method 'importFile' can only be passed a file literal, but '{moduleSpecifier}' was found.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "For-incrementor expression must be an assignment expression of the form 'identifier = expression', 'identifier += expression', 'identifier -= expression', or a postfix increment 'identifer++' or postfix decrement 'identifier--'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Variable declaration '{name}' must have an initializer.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Variable declaration for for-intializer must be of the form 'let identifier = expression'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Variable declaration for for-of-initializer must be of the form 'let identifier'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "for-in loops are not allowed in DScript. Use for-of loops instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Non-constant enums are not allowed. Add 'const' modifier to enum declaration.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Floating point numbers are not allowed in DScript.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Literal '{literal}' is outside the range of 'number'. DScript does not support the numeric value 'Infinity'.",
            Keywords = (int)(Events.Keywords.UserMessage | Events.Keywords.Diagnostics))]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Keyword 'extends' is expected.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Unexpected expression '{expression}'. An interface can only be extended by an identifier with optional type parameters.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Non-strict equality ('==') is not allowed. Use strict equality ('===') instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Modifier '{modifier}' is not allowed on an import declaration.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Warning,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'export import' is obsolete. Please convert this into two separate statements: an import and an export declaration.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Warning,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "A declaration is being exported, but its containing namespace is not. Maybe you forgot to export the namespace?",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Export declarations are not allowed in a namespace.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Default import/export is not allowed in DScript. Use `import {{name}} from spec` syntax instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Custom ambient declarations are not allowed in DScript.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Division operator is not allowed. Maybe you tried to create a path? Use an explicit path operator in that case. E.g. p`a/b/c`.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier declaration should be the only one in the statement. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template declaration should be the only one in the statement. " + TemplateDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier declaration does not contain all required modifiers. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template declaration does not contain all required modifiers. " + TemplateDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template declaration should be the first statement in the block.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier declaration should include a type declaration. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier key should be an identifier. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type member should be a string literal, or a union of string literals. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type should reference an interface or be an inline type literal. " + QualifierDeclarationExample,
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type should reference '{wellKnownQualifierType}' type or reference an interface that directly inherits from it.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier type members should not be optional.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The type name '{wellKnownQualifierType}' is reserved.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "The current qualifier can only be referenced as '{currentQualifier}'. Namespace qualifications are not allowed.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Expression expected.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'{currentQualifier}' is a reserved keyword that can only be used in variable declarations.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'{template}' is a reserved keyword that can only be used in variable declarations.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Qualifier declarations can only occur directly under a namespace or at the top level of a file.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template declarations can only occur directly under a namespace or at the top level of a file.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Path-based specifier '{specifier}' is not allowed in a spec that belongs to a module with implicit reference semantics. Make sure the value you want to reference is exported and reference it directly.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "An initializer must be present in template declarations.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template declaration should include a type declaration.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Template type cannot be 'any'.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "'{rootNamespaceName}' is a reserved keyword.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Found package name '{packageName}' in '{functionName}' call. Only relative paths (e.g. './Foo.dsc' or '/Bar.dsc') are allowed in '{functionName}' calls.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Found package name '{packageName}' in '{functionName}' call, which resembles a file path. Only relative and rooted paths are allowed, which must start with './', '/', or a drive.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Found config, package, or module file '{packageName}' in '{functionName}' call. These file types cannot expose anything.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Found 'importFile' call in a spec file. Use 'importFrom' instead.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Found non-module name '{packageName}' in 'importFrom' call in a spec file. 'importFrom' may only be passed module names (e.g. 'MyModule', not './path/to/spec') in projects within implicit semantics modules.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Ambient '{lhsName}.{rhsName}' cannot be used in a config file.",
            Keywords = (int)Events.Keywords.UserMessage)]
        ...
        [GeneratedEvent(
            ...
            EventLevel = Level.Error,
            EventTask = (ushort)Events.Tasks.Parser,
            Message = Events.LabeledProvenancePrefix + "Module '{moduleName}' should not import itself.",
            Keywords = (int)Events.Keywords.UserMessage)]
