...
export declare const qualifier : {targetFramework: "net462"};
...
export const framework : Shared.Framework = {
    ...
    assemblyInfoTargetFramework: ".NETFramework,Version=v4.6.2",

    assemblyInfoFrameworkDisplayName: ".NET Framework 4.6.2",
