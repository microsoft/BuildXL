...
namespace BuildXL.Scheduler.Performance
{
    ...
    public static class PerformanceDataUtilities
    {
        ...
        /// <see cref="BuildXL.Pips.Graph.PipGraph.Builder.ComputeGraphSemistableFingerprint(LoggingContext, IPipTable, PathTable, string)"/> and <see cref="BuildXL.Pips.Graph.PipGraph.SemistableFingerprint"/>
        /// </summary>
