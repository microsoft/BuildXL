...
- Expanded pip dump diagnostics to include dependency violation failures
- [Security] Fix CVE-2026-27904 by upgrading minimatch in the VS Code extension
- [Linux Sandbox] Add configurable flag to control whether stat operations are treated as reads or probes, allowing per-customer cache hit rate tuning
- Improved Detours injection reliability by suppressing transient retry-able failure errors
- Cleaner error logging by removing redundant exit code error messages

# 0.1.0-20260306.2 (Release [31146848](https://dev.azure.com/mseng/Domino/_build/results?buildId=31146848&view=results))
- Add net10 support for NugetSpecGenerator
- Add dark mode support to html generated by analyzers
- Add a direct Kusto ingestion mechanism to log unstructured telemetry
