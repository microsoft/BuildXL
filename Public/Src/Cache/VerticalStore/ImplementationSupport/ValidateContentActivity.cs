...
namespace BuildXL.Cache.ImplementationSupport
{
    ...
    /// </summary>
    public sealed class ValidateContentActivity : CacheActivity
    {
        /// <summary>
        ...
        public ValidateContentActivity(EventSource eventSource, Guid relatedActivityId, ICacheReadOnlySession cache)
            : base(
                eventSource,
                new EventSourceOptions
                {
                    Level = EventLevel.Informational,
                    Keywords = Keywords.TelemetryKeyword | Keywords.ValidateContent,
                },
                relatedActivityId,
                InterfaceNames.ValidateContent,
                cache.CacheId)
        {
        }
