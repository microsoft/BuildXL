...
namespace BuildXL.Cache.ImplementationSupport
{
    ...
    /// </summary>
    public sealed class AddToCasStreamActivity : CacheActivity
    {
        /// <summary>
        ...
        public AddToCasStreamActivity(EventSource eventSource, Guid relatedActivityId, ICacheReadOnlySession cache)
            : base(
                eventSource,
                new EventSourceOptions
                {
                    Level = EventLevel.Informational,
                    Keywords = Keywords.TelemetryKeyword | Keywords.AddToCas,
                },
                relatedActivityId,
                InterfaceNames.AddToCasStream,
                cache.CacheId)
        {
        }
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Usage", "CA1801:ParameterNeverUsed", Justification = "Consistency with the API and potential future use")]
        public void Start(Stream filestream, UrgencyHint urgencyHint)
        {
            Start();
        ...
        /// </notes>
        public Possible<CasHash, Failure> Returns(Possible<CasHash, Failure> result)
        {
            if (result.Succeeded)
            {
