...
namespace BuildXL.Utilities
{
    ...
    public readonly struct FileArtifact : IEquatable<FileArtifact>, IImplicitPath
    {
        ...
        /// <summary>
        /// Creates a FileArtifact. This is internal to avoid exposing it as part of the Transformer authoring API.
        /// </summary>
        ...
        /// transformers were able to create file artifacts of arbitrary versions,
