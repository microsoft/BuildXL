...
**Microsoft employees** should make contributions to the BuildXL.Internal repository. Please follow the steps in the [internal documentation](https://aka.ms/buildxl) to request entitlement.
