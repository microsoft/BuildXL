...
public sealed class GrpcCopyClient : StartupShutdownSlimBase
{
    ...
    {
        await _channel.ConnectAsync(Key.Location, _clock, _configuration.ConnectionTimeout);
    ...
    private Metadata? GetHeaders(Metadata? headers)
    {
        ...
        headers.Add(GrpcMetadataConstants.MachineMetadataFieldName, Environment.MachineName);
